...
const lapanganSchema = new Schema({
    ...
    pengelola: { type: String, Required: true, min: 5, max: 255 },
    contact: { type: String, Required: true, min: 5, max: 255 },
    address: { type: String, Required: true, min: 5, max: 255 },
    price: { type: Number, Required: true, min: 5, max: 255 },
    openTime: { type: String, Required: true, min: 5, max: 255 },
    closeTime: { type: String, Required: true, min: 5, max: 255 },
